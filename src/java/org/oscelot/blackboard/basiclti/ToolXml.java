...
public class ToolXml extends HttpServlet {
  ...
  private String xmlProperty(String name, String value) {
    ...
    if ((value == null) || (value.length() <= 0)) {
      ...
      property = "    <lticm:property name=\"" + name + "\">" + value + "</lticm:property>\n";
    }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    xml.append("  <title>").append(tool.getName()).append("</title>\n");
    xml.append("  <description>As at ").append(Utils.formatCalendar(Calendar.getInstance(), Constants.DATE_FORMAT)).append("</description>\n");
    xml.append("  <launch_url>").append(tool.getUrl()).append("</launch_url>\n");
    xml.append("  <secure_launch_url />\n");
    xml.append(xmlParameter("icon", tool.getIcon()));
...
//    xml.append(xmlProperty(Constants.TOOL_GUID, tool.getGUID()));
//    xml.append(xmlProperty(Constants.TOOL_SECRET, tool.getSecret()));
...
/*
    xml.append("    <vendor>\n");
    xml.append("        <lticp:code>ims</lticp:code>\n");
    xml.append("        <lticp:name>IMS</lticp:name>\n");
    xml.append("        <lticp:description>IMS Global Learning Consortium</lticp:description>\n");
    xml.append("        <lticp:url>http://www.imsglobal.org/</lticp:url>\n");
    xml.append("        <lticp:contact>\n");
    xml.append("            <lticp:email>info@imsglobal.org</lticp:email>\n");
    xml.append("        </lticp:contact>\n");
    xml.append("    </vendor>\n");
*/
