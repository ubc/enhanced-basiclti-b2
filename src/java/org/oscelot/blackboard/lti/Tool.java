...
// Format types of text box values
  ...
  public String getId(boolean root) {

    String id = this.id;
    if (root && (this.prefix != null)) {
      String[] parts = this.prefix.split("\\.");
      if (parts.length > 0) {
  ...
  public String getOutcomesPointsPossible() {
    ...
    return this.getToolSetting(false, true, Constants.TOOL_EXT_OUTCOMES_POINTS,
       this.getToolSetting(Constants.TOOL_EXT_OUTCOMES_POINTS, Constants.DEFAULT_POINTS_POSSIBLE));
