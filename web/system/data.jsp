...
<%
  ...
  if (request.getMethod().equalsIgnoreCase("POST")) {
    ...
    b2Context.setSetting(toolSettingPrefix + Constants.TOOL_ENCRYPT_EMAIL_RANDOM_NAME, b2Context.getRequestParameter(Constants.TOOL_ENCRYPT_EMAIL_RANDOM_NAME, Constants.DATA_FALSE));
  ...
  params.put(Constants.TOOL_ENCRYPT_EMAIL_RANDOM_NAME, b2Context.getSetting(toolSettingPrefix + Constants.TOOL_ENCRYPT_EMAIL_RANDOM_NAME, Constants.DATA_FALSE));
